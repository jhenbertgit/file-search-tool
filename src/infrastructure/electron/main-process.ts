...
export class ElectronMainProcess {
  ...
  private setupIPC(): void {
    ...
    // Get app version using Electron's built-in method
    ipcMain.handle("get-app-version", () => {
      try {
        // Use app.getVersion() which works reliably in both dev and production
        // This method reads the version from package.json at startup and caches it
  ...
  private async createWindow(): Promise<void> {
    ...
    // Always load HTML from dist directory to ensure correct relative paths for scripts
    // The dist HTML file has correct paths to compiled JS and CSS files
